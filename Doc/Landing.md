...
Introduction.sec=<b>Our most standardized work. <a href="index.php?action=list&file=G/">Prose Objects in folder /G/</a><br>Overview:</b><ul><li>{SSRN.sec}<li>{Slack.sec} &emsp; {Blog.sec}<li>{CmAQuick.sec}<li>{CmAbqc.sec}<li>{Codification.sec}<li>{Code-ification.sec}</ul>
